    ...
    switch($_GET["op"]){
        ...
        case "guardaryeditar":
            if(empty($_POST["usu_id"])){       
                $menu->insert_usuario($_POST["usu_nombre"],$_POST["usu_ape"],$_POST["usu_ape_mat"],$_POST["usu_correo"],$_POST["usu_pass"],$_POST["fecha_crea"],$_POST["rol_id"]);     
            }
            else {
                $menu->update_usuario($_POST["usu_id"],$_POST["usu_nombre"],$_POST["usu_ape"],$_POST["usu_ape_mat"],$_POST["usu_correo"],$_POST["usu_pass"],$_POST["fecha_crea"],$_POST["rol_id"]); 
            }
        break;
